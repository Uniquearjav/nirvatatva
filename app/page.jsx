        ...
        <div className="text-center">
          ...
          <div className="flex justify-center w-full max-w-2xl gap-2 mx-auto mt-6">
            <div className="mt-3 rounded-lg sm:mt-0">
              <a className="px-5 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-blue-600 lg:px-10 rounded-xl ">Get bundle</a>
            </div>
            <div className="mt-3 rounded-lg sm:mt-0 sm:ml-3">
              <a className="items-center px-5 lg:px-10 py-3.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl ">See features</a>
            </div>
          </div>
        </div>
      </div>
